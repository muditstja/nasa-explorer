  ...
  return (
    <div className="card" style={{ overflow: 'hidden' }}>
      <div className="card-head" style={{ padding: 16 }}>
        <div>
          <h2 className="h2" style={{ margin: 0 }}>EONET — Earth Events</h2>
      ...
      <div className="chips" style={{ padding: '0 16px 10px 16px' }}>
        {['Wildfires','Severe Storms','Volcanoes','Floods','Dust & Haze','Snow & Ice','Earthquakes'].map((k)=> (
          <label key={k} className="chip" style={{ borderColor: includeCats.includes(k) ? 'var(--accent, #8bd3ff)' : undefined }}>
